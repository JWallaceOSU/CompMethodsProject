...
class ApplicationWindow(QMainWindow):
    def __init__(self):
        ...
        sc = MyStaticMplCanvas(parent =self.main_widget, width=5, height=4, dpi=100, title='Title 1')
        dc = MyDynamicMplCanvas(parent = self.main_widget, width=5, height=4, dpi=100, title='Title 2')
